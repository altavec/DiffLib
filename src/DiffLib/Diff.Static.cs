// <copyright file="Diff.Static.cs" company="Altavec">
...
public static class Diff
{
    ...
    /// <para><paramref name="collection2"/> is <see langword="null"/>.</para>
    /// </exception>
    public static IEnumerable<DiffSection> CalculateSections<T>(IList<T?> collection1, IList<T?> collection2, DiffOptions? options, IEqualityComparer<T?>? comparer = null) => (collection1, collection2) switch
    {
