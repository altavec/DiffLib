...
public static class ListExtensions
{
    ...
    /// <param name="comparer">The optional <see cref="IEqualityComparer{T}"/> to use when comparing elements. If not specified/<c>null</c>, <see cref="EqualityComparer{T}.Default"/> will be used.</param>
    /// <param name="aligner">The <see cref="IDiffElementAligner{T}"/> to use when aligning elements. If not specified/<c>null</c>, <see cref="BasicReplaceInsertDeleteDiffElementAligner{T}"/> will be used.</param>
    ...
    /// <param name="target">The list to mutate. Elements will possibly be inserted into or deleted from this list.</param>
    /// <param name="source">The list to use as the source of mutations for <paramref name="target"/>.</param>
    /// <param name="options">A <see cref="DiffOptions"/> object specifying options to the diff algorithm, or <c>null</c> if defaults should be used.</param>
    /// <param name="comparer">The optional <see cref="IEqualityComparer{T}"/> to use when comparing elements. If not specified/<c>null</c>, <see cref="EqualityComparer{T}.Default"/> will be used.</param>
    /// <param name="aligner">The <see cref="IDiffElementAligner{T}"/> to use when aligning elements. If not specified/<c>null</c>, <see cref="BasicReplaceInsertDeleteDiffElementAligner{T}"/> will be used.</param>
    /// <exception cref="ArgumentNullException">
    /// <para><paramref name="target"/> is <c>null</c>.</para>
