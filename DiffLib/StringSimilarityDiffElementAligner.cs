...
public class StringSimilarityDiffElementAligner(double modificationThreshold = 0.3333) : IDiffElementAligner<string?>
{
    ...
    /// </exception>
    public IEnumerable<DiffElement<string?>> Align(IList<string?> collection1, int start1, int length1, IList<string?> collection2, int start2, int length2) => this.aligner.Align(collection1, start1, length1, collection2, start2, length2);
